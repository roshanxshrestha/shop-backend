...
Route::group(['namespace' => 'Api\V1'], function () {
    //http://localhost:8000/App/Http/Controllers/api/v1/products/popular >> this is how full request looks like in backend -roshan
       ...
       Route::group(['prefix' => 'products'], function () {
        Route::get('popular', 'ProductController@get_popular_products');
         Route::get('recommended', 'ProductController@get_recommended_products');
          ...
          Route::get('maincourse', 'ProductController@get_main_course');
        }); 
